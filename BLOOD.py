...
db=MySQLdb.connect("localhost","root","sharang","bbms")
cursor=db.cursor()

root=Tk()		
image1=PhotoImage(file="/home/sharang/WorkSpace/Python/BloodBankManagementSystemPython/bg.gif")
